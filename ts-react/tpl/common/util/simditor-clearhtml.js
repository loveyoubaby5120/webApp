// Derived from:
// https://github.com/uuke/simditor-clearhtml/blob/master/lib/simditor-clearhtml.js
...
SimditorClearHtml = (function (superClass) {
    ...
    SimditorClearHtml.prototype.iconClassOf = function () {
        return 'simditor-clearhtml-fa-eraser';
    };
    ...
    SimditorClearHtml.prototype.command = function () {
        ...
        if (startNode.nodeType === Node.TEXT_NODE) {
            if (startOffset > 0) {
                ...
                var selected = document.createTextNode(startNode.nodeValue.substring(startOffset));
