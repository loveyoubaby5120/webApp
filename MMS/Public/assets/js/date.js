...
(function ($) {      
    $.fn.date = function (options,Ycallback,Ncallback) {   
        ...
        //var initY=parseInt((nowdate.getFullYear()+"").substr(1,2));
        ...
        function init_iScrll() { 
        	//strY 和 strM 应该放在onScrollEnd内 by Wangyueb
        ...
        function CreateDateUI(){
            var str = ''+
                ...
                '</div>'
            $("#datePlugin").html(str);
            $('#datescroll,#dateshadow').on('touchstart',function(e){e.preventDefault();});
        }
