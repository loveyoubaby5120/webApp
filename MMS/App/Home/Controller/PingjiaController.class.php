 ...
 $this->assign('shopidlist', $shopidlist); 
  ...
  public function _befor_update($data){
   ...
   public function outxls() {
		...
		$list = $model->where($map)->field('id,shopid,juid,juname,hid,xingming,kahao,pingfen,title,content')->select();
	    $headArr=array('ID','所在店铺','员工ID','员工姓名','会员ID','会员姓名','卡号','评分','评价详情','员工回评');
	    $filename='评价管理';
