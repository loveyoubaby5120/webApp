...
class SmssController extends CommonController{
 ...
 $this->assign('jieguolist', $jieguolist); 
  ...
  public function _befor_update($data){
   ...
   public function outxls() {
		...
		$list = $model->where($map)->field('id,phone,content,jieguo,url,ip')->select();
	    $headArr=array('ID','手机号码','发送内容','发送结果','发送网址','来源IP');
	    $filename='短信发送记录';
