...
export default class Chart extends React.Component {
    ...
    render() {
        ...
        return (
    		<div className="chart">
                <ul>
                    <li className={this.state.type==1 ? "item first active" : "item first"} onClick={this.onClick.bind(this,1,'话题传播数量趋势')}><a href="javascript:;">话题传播数量趋势</a></li>
                    <li className={this.state.type==2 ? "item active" : "item"} onClick={this.onClick.bind(this,2,'题舆论走势')}><a href="javascript:;">题舆论走势</a></li>
                    <li className={this.state.type==3 ? "item active" : "item"} onClick={this.onClick.bind(this,3,'话题脉搏')}><a href="javascript:;">话题脉搏</a></li>
                </ul>
