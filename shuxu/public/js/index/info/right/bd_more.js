        ...
        $.ajax({
            ...
            success: function(datas){
                ...
                datas.forEach(function(data,index){
                    ...
                    //粉丝黏性
                    var div5 = React.createElement('div',null,(data.viscous).toFixed(4));
                    var td5 = React.createElement('td',{className:'text'},div5);
                    
                    //粉丝活跃度
                    var div6 = React.createElement('div',null,(data.receiver).toFixed(4));
                    var td6 = React.createElement('td',{className:'text'},div6);
                    
                    //增长潜力
                    var div7 = React.createElement('div',null,(data.growth).toFixed(4));
